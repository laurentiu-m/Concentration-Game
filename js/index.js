...
// Call the function that starts the Concentration Game
startButton.addEventListener("click", startConcentrationGame);
startButton.addEventListener("touchstart", startConcentrationGame)
...
function startConcentrationGame() {
  ...
  function buildIcon(icon, index) {
    ...
    cards[index].addEventListener("touchend", clickEvent);
    cards[index].addEventListener("click", clickEvent);
    function clickEvent() {
